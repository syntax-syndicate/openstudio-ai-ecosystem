      ...
      <Dialog open={isSettingOpen} onOpenChange={setIsSettingOpen}>
        <DialogContent className="flex max-h-[80dvh] w-[96dvw] flex-col gap-0 overflow-hidden rounded-xl border border-white/5 p-0 md:h-[600px] md:min-w-[800px]">
          ...
          <div className="relative flex h-full w-full flex-col md:flex-row">
            <div className="absolute top-0 right-0 left-0 flex w-full flex-row gap-1 border-zinc-500/10 border-r px-2 md:bottom-0 md:w-[250px] md:flex-col md:gap-0">
            ...
            <div className="no-scrollbar h-full w-full overflow-y-auto pb-16 md:ml-[250px]">
