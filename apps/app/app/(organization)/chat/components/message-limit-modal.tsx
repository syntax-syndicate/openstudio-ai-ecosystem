...
export const MessageLimitModal = () => {
  ...
  return (
    <Dialog
      open={openMessageLimitModal}
      onOpenChange={setOpenMessageLimitModal}
    >
      <DialogContent
      ...
      >
        ...
        <DialogDescription>
          You have exceeded the message limit for this month. Usage based
          pricing is WIP for more messages.
        </DialogDescription>
      </DialogContent>
    </Dialog>
  );
