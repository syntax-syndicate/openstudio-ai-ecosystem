...
export const SelectedContext = () => {
  ...
  return (
    <div className="flex w-full flex-row items-start justify-start gap-2 rounded-xl border border-zinc-100 bg-white py-2 pr-2 pl-2 text-zinc-700 ring-1 ring-zinc-100 md:w-[640px] lg:w-[700px] dark:border-white/10 dark:bg-zinc-800 dark:text-zinc-200 dark:ring-zinc-700">
