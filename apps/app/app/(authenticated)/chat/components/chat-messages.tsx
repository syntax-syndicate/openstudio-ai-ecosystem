    ...
    return (
      <div className="flex w-full flex-col items-end gap-1" key={message.id}>
        {message?.props?.context && (
          <div className="flex flex-row gap-2 rounded-2xl border border-transparent bg-zinc-50 p-2 pr-4 pl-3 text-sm md:text-base text-zinc-600 hover:border-white/5 dark:bg-black/30 dark:text-zinc-100">
            <ArrowElbowDownRight
              size={20}
              weight="bold"
        ...
        <div className="ml-16 flex flex-row gap-2 rounded-2xl bg-zinc-50 px-3 py-2 text-sm md:text-base text-zinc-600 dark:bg-black/30 dark:text-zinc-100">
