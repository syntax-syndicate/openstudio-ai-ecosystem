...
const AssistantPage = () => {
  ...
  const renderAssistant = (assistant: TCustomAssistant, canDelete: boolean) => {
    return (
      <div
        key={assistant.key}
        className="group relative flex cursor-pointer flex-col items-center gap-2 rounded-xl border px-4 pt-6 pb-4 hover:bg-zinc-50 dark:hover:bg-zinc-900"
      >
        {assistant.iconURL ? (
  ...
  return (
    <>
      <Flex
        className="w-full border-zinc-500/15 border-b bg-zinc-25 px-2 py-2.5 dark:bg-zinc-800"
        items="center"
        gap="sm"
      >
        <Button
