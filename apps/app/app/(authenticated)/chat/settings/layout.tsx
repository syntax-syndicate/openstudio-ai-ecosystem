...
export default function SettingsPage({
  ...
  return (
    <div className="relative flex h-screen w-full flex-col overflow-hidden bg-white md:flex-row dark:bg-zinc-800">
      <div className="no-scrollbar absolute top-0 right-0 left-0 flex w-full flex-row items-end gap-1 overflow-x-auto border-zinc-500/10 bg-zinc-50 px-2 pt-2 pb-2 md:bottom-0 md:h-full md:w-[300px] md:flex-col md:gap-0 md:overflow-y-auto md:pb-16 dark:bg-zinc-900/50">
      ...
      <div className="no-scrollbar mt-12 h-full w-full max-w-[700px] overflow-y-auto p-8 pb-16 md:mt-0 md:ml-[300px]">
        {children}
      </div>
    </div>
  );
