...
>(({ className, children, ariaTitle, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
          "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] fixed left-[50%] top-[10%] z-50 grid w-[96dvw] translate-x-[-50%] translate-y-[-10%] gap-4 rounded-2xl bg-white p-6 shadow-lg duration-200 dark:bg-zinc-700 md:top-[25%] md:w-full md:max-w-[600px] md:translate-y-[-25%]",
        className
      )}
      {...props}
    >
